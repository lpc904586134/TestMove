...
/**
 * 通过offsetLeftAndRight方法水平移动view,
 * 垂直移动使用offsetTopAndBottom
 */
public class MoveViewByOffsetLeftAndRight extends View {
    ...
    private int lastX;
    private int lastY;
    public MoveViewByOffsetLeftAndRight(Context context) {
        super(context);
        init(context);
    }

    public MoveViewByOffsetLeftAndRight(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MoveViewByOffsetLeftAndRight(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MoveViewByOffsetLeftAndRight(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
