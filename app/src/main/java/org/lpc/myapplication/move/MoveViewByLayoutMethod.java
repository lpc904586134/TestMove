...
/**
 * 通过view.layout方法水平移动view
 */
public class MoveViewByLayoutMethod extends View {
    ...
    public MoveViewByLayoutMethod(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
